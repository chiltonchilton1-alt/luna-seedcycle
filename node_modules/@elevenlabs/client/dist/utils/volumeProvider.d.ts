...
export declare const NO_VOLUME: VolumeProvider;
export declare const MIN_VOICE_FREQUENCY = 100;
export declare const MAX_VOICE_FREQUENCY = 8000;
/**
 ...
 */
export declare function resampleVoiceRange(raw: Uint8Array<ArrayBuffer>, buffer: Uint8Array<ArrayBuffer>, sampleRate: number): void;
export declare function createAnalyserVolumeProvider(analyser: AnalyserNode, sampleRate: number): VolumeProvider;
//# sourceMappingURL=volumeProvider.d.ts.map